...
* Intraday Patterns
use "${working_data}UserSignedIn", clear
gen creationdateutc=creationdate
...
graph export  ${results}Heatplot.png, replace
...
sort userId date
destring type_tcreated type_tcreated direction, replace
